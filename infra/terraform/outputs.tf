...
output "power_tuner_arn" {
  value  = aws_serverlessapplicationrepository_cloudformation_stack.power_tuner.outputs["aws_serverlessapplicationrepository_cloudformation_stack.power_tuner.outputs["StateMachineARN"]
}
